...
int main(int argc, const char * argv[])
{
    ...
    GLAppearance* apperance_0 = new GLAppearance("../Shaders/homework4.vs", "../Shaders/homework4.fs");
    ...
    int texid = texture->loadAndCreateTextures("../Textures/Color_Gradient.bmp", "../Textures/cat.bmp", "../Textures/pineapple.bmp");
