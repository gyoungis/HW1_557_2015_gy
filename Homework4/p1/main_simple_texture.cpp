...
int main(int argc, const char * argv[])
{
    ...
    GLAppearance* apperance_0 = new GLAppearance("../Shaders/single_texture.vs", "../Shaders/single_texture.fs");
    ...
    spotlight_source._cone_angle = 15.0;
    
    apperance_0->addLightSource(spotlight_source);
    
    // Create a material object
    GLMaterial material_0;
    material_0._diffuse_material = glm::vec3(0.0, 0.0, 0.2);
    material_0._ambient_material = glm::vec3(0.0, 0.0, 0.2);
    ...
    int texid = texture->loadAndCreateTexture("../Textures/cat.bmp");
