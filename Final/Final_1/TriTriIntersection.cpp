                      ...
                      float U0[3],float U1[3],float U2[3])
{
  ...
  if(fabs(du0)<TRIEPSILON) du0=0.0;
  if(fabs(du1)<TRIEPSILON) du1=0.0;
  if(fabs(du2)<TRIEPSILON) du2=0.0;
#endif
  du0du1=du0*du1;
  du0du2=du0*du2;
...
#if USE_EPSILON_TEST==TRUE
  if(fabs(dv0)<TRIEPSILON) dv0=0.0;
  if(fabs(dv1)<TRIEPSILON) dv1=0.0;
  if(fabs(dv2)<TRIEPSILON) dv2=0.0;
#endif
